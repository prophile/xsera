...
--	graphics.set_camera(-480, -360, 480, 360)
	execs[num] = { coordx = splash_shift_left, coordy = top_of_splash - (num - 1) * splash_stride, length = splash_shift_right - splash_shift_left, text = "Start New Game", justify = "left", boxColor = CYELLOW, textColor = c_purple, execute = nil, mid = splash_shift_left + 60, letter = "S" }
	num = num + 1
	execs[num] = { coordx = splash_shift_left, coordy = top_of_splash - (num - 1) * splash_stride, length = splash_shift_right - splash_shift_left, text = "Start Network Game", justify = "left", boxColor = CDGREEN, textColor = c_purple, execute = nil, mid = splash_shift_left + 60, letter = "N" }
	num = num + 1
	execs[num] = { coordx = splash_shift_left, coordy = top_of_splash - (num - 1) * splash_stride, length = splash_shift_right - splash_shift_left, text = "Replay Intro", justify = "left", boxColor = CGREY, textColor = c_purple, execute = nil, mid = splash_shift_left + 60, letter = "R" }
	num = num + 1
	execs[num] = { coordx = splash_shift_left, coordy = top_of_splash - (num - 1) * splash_stride, length = splash_shift_right - splash_shift_left, text = "Demo", justify = "left", boxColor = CGREYBROWN, textColor = c_purple, execute = nil, mid = splash_shift_left + 60, letter = "D" }
	num = num + 1
	execs[num] = { coordx = splash_shift_left, coordy = top_of_splash - (num - 1) * splash_stride, length = splash_shift_right - splash_shift_left, text = "Options", justify = "left", boxColor = CLGREEN, textColor = c_purple, execute = nil, mid = splash_shift_left + 60, letter = "O" }
	num = num + 1
	execs[num] = { coordx = splash_shift_left, coordy = top_of_splash - (num - 1) * splash_stride, length = splash_shift_right - splash_shift_left, text = "About Ares and Xsera", justify = "left", boxColor = CGREYBROWN, textColor = c_purple, execute = nil, mid = splash_shift_left + 60, letter = "A" }
	num = num + 1
	execs[num] = { coordx = splash_shift_left, coordy = top_of_splash - (num - 1) * splash_stride, length = splash_shift_right - splash_shift_left, text = "Xsera Main Menu", justify = "left", boxColor = CYELLOW, textColor = c_purple, execute = nil, mid = splash_shift_left + 60, letter = "M" }
	num = num + 1
	execs[num] = { coordx = splash_shift_left, coordy = top_of_splash - (num - 1) * splash_stride, length = splash_shift_right - splash_shift_left, text = "Quit", justify = "left", boxColor = c_lightRed, textColor = c_purple, execute = nil, mid = splash_shift_left + 60, letter = "Q" }
end
