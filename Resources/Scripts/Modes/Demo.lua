...
function startdemo ()
    while (demogoing == nil)
		...
		graphics.draw_sprite("Gaitori/Carrier", spriteSheetX, spriteSheetY, carrierLocation[1], carrierLocation[2], carrierSize[1], carrierSize[2])
		graphics.draw_sprite("Ishiman/HeavyCruiser", spriteSheetX, spriteSheetY, hCruiserLocation[1], hCruiserLocation[2], hCruiserSize[1], hCruiserSize[2])
