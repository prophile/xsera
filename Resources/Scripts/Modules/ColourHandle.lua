...
-- delete these as they become replaced from the CLUT
...
c_rust = { r = 0.7, g = 0.3, b = 0.0, a = 1.0 }
...
c_yellow2 = { r = 0.5, g = 0.5, b = 0.0, a = 1.0 }
c_yellow3 = { r = 0.4, g = 0.4, b = 0.0, a = 1.0 }
c_yellow4 = { r = 0.2, g = 0.2, b = 0.0, a = 1.0 }
c_yellow5 = { r = 0.5, g = 0.5, b = 0.2, a = 1.0 }
