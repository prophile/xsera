...
function draw_interface_box(box, col_mod_all, col_mod_click)
	if box.underbox ~= nil then
		graphics.draw_box(box.coordy + 18, box.coordx, box.underbox, box.coordx + box.length, 0, clut_colour(1, 17))
	else
		graphics.draw_box(box.coordy + 18, box.coordx, box.coordy, box.coordx + box.length, 0, clut_colour(1, 17))
	end
	...
	if (box.text ~= " ") and (box.text ~= "nodraw") then
		graphics.draw_box(box.coordy + 14, box.coordx + 11, box.coordy + 4, box.coordx + 10 + txtlength * 2, 0, clut_lighten(box.boxColour, col_mod_all + 1))
		graphics.draw_box(box.coordy + 14, box.coordx + 11 + txtlength * 2, box.coordy + 4, box.coordx + box.length - 11, 0, clut_lighten(box.boxColour, col_mod_click - 1))
		graphics.draw_text(box.text, "CrystalClear", "center", box.coordx + 11 + txtlength * 9 / 2, box.coordy + 9, 14, clut_lighten(box.boxColour, col_mod_all + 1)) 
	else
		graphics.draw_box(box.coordy + 14, box.coordx + 11, box.coordy + 4, box.coordx + 10 + txtlength * 2, 0, clut_lighten(box.boxColour, col_mod_all - 1))
		graphics.draw_box(box.coordy + 14, box.coordx + 11 + txtlength * 2, box.coordy + 4, box.coordx + box.length - 11, 0, clut_lighten(box.boxColour, col_mod_all + 1))
	end
	if box.special ~= "disabled" then
		graphics.draw_text(box.letter, "CrystalClear", "center", box.coordx + 11 + txtlength, box.coordy + 9, 14) 
	end
	if box.radio == "off" then
		graphics.draw_box(box.coordy + 13, box.coordx - 2, box.coordy + 4, box.coordx + 5, 0, clut_lighten(box.boxColour, col_mod_all))
		graphics.draw_box(box.coordy + 15, box.coordx - 5, box.coordy + 3, box.coordx - 3, 0, clut_lighten(box.boxColour, col_mod_all))
		graphics.draw_box(box.coordy + 15, box.coordx - 15, box.coordy + 3, box.coordx - 13, 0, clut_lighten(box.boxColour, col_mod_all))
		graphics.draw_box(box.coordy + 15, box.coordx - 15, box.coordy + 13, box.coordx - 3, 0, clut_lighten(box.boxColour, col_mod_all))
		graphics.draw_box(box.coordy + 5, box.coordx - 15, box.coordy + 3, box.coordx - 3, 0, clut_lighten(box.boxColour, col_mod_all))
	elseif box.radio == "on" then
		...
		graphics.draw_box(box.coordy + 15, box.coordx - 15, box.coordy + 13, box.coordx - 3, 0, clut_lighten(box.boxColour, col_mod_all))
		graphics.draw_box(box.coordy + 5, box.coordx - 15, box.coordy + 3, box.coordx - 3, 0, clut_lighten(box.boxColour, col_mod_all))
		graphics.draw_box(box.coordy + 11, box.coordx - 11, box.coordy + 7, box.coordx - 7, 0, clut_lighten(box.boxColour, col_mod_all))
	end
	-- frame boxes
	graphics.draw_box(box.coordy + 3, box.coordx, box.coordy + 2, box.coordx + 10, 0, clut_lighten(box.boxColour, col_mod_all))
	graphics.draw_box(box.coordy + 3, box.coordx + box.length - 10, box.coordy + 2, box.coordx + box.length, 0, clut_lighten(box.boxColour, col_mod_all))
	graphics.draw_box(box.coordy + 2, box.coordx, box.coordy, box.coordx + box.length, 0, clut_lighten(box.boxColour, col_mod_all))
	graphics.draw_box(box.coordy + 16, box.coordx, box.coordy + 14, box.coordx + 10, 0, clut_lighten(box.boxColour, col_mod_all))
	graphics.draw_box(box.coordy + 16, box.coordx + box.length - 10, box.coordy + 14, box.coordx + box.length, 0, clut_lighten(box.boxColour, col_mod_all))
	graphics.draw_box(box.coordy + 18, box.coordx, box.coordy + 16, box.coordx + box.length, 0, clut_lighten(box.boxColour, col_mod_all))
	graphics.draw_box(box.coordy + 13, box.coordx, box.coordy + 4, box.coordx + 10, 0, clut_lighten(box.boxColour, col_mod_all))
	graphics.draw_box(box.coordy + 13, box.coordx + box.length - 10, box.coordy + 4, box.coordx + box.length, 0, clut_lighten(box.boxColour, col_mod_all))
	...
	if box.underbox ~= nil then
		...
		graphics.draw_box((box.coordy + box.underbox + 2) / 2, box.coordx, box.underbox + 6, box.coordx + 10, 0, clut_darken(box.boxColour))
		...
		graphics.draw_box((box.coordy + box.underbox + 2) / 2, box.coordx + box.length - 10, box.underbox + 6, box.coordx + box.length, 0, clut_darken(box.boxColour))
...
function draw_small_box(box)
	local backgroundCol = clut_colour(1, 17)
	...
	graphics.draw_box(box.top - 5, box.left, (box.top + box.bottom) / 2, box.left + 3, 0, clut_lighten(box.boxColour))
	graphics.draw_box((box.top + box.bottom) / 2 - 1, box.left, box.bottom + 5, box.left + 3, 0, clut_darken(box.boxColour))
	...
	graphics.draw_box(box.top - 5, box.right - 3, (box.top + box.bottom) / 2, box.right, 0, clut_lighten(box.boxColour))
	graphics.draw_box((box.top + box.bottom) / 2 - 1, box.right - 3, box.bottom + 5, box.right, 0, clut_darken(box.boxColour))
	if box.title ~= nil then
		graphics.draw_box(box.top - 5, box.left + 4, box.top - 25, box.right - 4, 0, clut_lighten(box.boxColour, 3))
		graphics.draw_text(box.title, "CrystalClear", "left", box.left + 10, box.top - 15, 18, clut_colour(1, 17))
	end
	if box.subtitle ~= nil then
		graphics.draw_text(box.subtitle, "CrystalClear", "left", box.left + 10, box.top - 35, 18, clut_colour(1, 17))
	end
--	graphics.draw_text(box.desc, "CrystalClear", "left", box.left + 10, box.top - 55, 18, clut_colour(1, 17)) [TEXTFIX] re-enable when text is fixed
end
