...
-- scenario-specific
		entObject.planet =  { name = trueData.pname,
			...
			buildCost = { tonumber(trueData.pbuildcost1), tonumber(trueData.pbuildcost2), tonumber(trueData.pbuildcost3), tonumber(trueData.pbuildcost4) },
			buildTime = { tonumber(trueData.pbuildtime1), tonumber(trueData.pbuildtime2), tonumber(trueData.pbuildtime3), tonumber(trueData.pbuildtime4) },
			type = "Planet",
		...
		entObject.planet2 =  { name = trueData.p2name,
			...
			buildCost = { tonumber(trueData.p2buildcost1), tonumber(trueData.p2buildcost2), tonumber(trueData.p2buildcost3), tonumber(trueData.p2buildcost4) },
			buildTime = { tonumber(trueData.p2buildtime1), tonumber(trueData.p2buildtime2), tonumber(trueData.p2buildtime3), tonumber(trueData.p2buildtime4) },
			type = "Planet",
...
-- ship-specific
		...
		entObject.warp = { stage = "notWarping", lastPlayed = 0, time = 0.0 }
